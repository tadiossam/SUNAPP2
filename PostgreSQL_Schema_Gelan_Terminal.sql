...
--
-- Name: dynamics365_settings dynamics365_settings_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dynamics365_settings
    ADD CONSTRAINT dynamics365_settings_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.employees(id);
...
ALTER TABLE ONLY public.system_settings
    ADD CONSTRAINT system_settings_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.employees(id);
